    ...
    <header className="masthead">
      ...
      <div className={`mobileNavOverlay${mobileNavOpen ? " isOpen" : ""}`} aria-hidden={!mobileNavOpen} onMouseDown={(event) => { if (event.target === event.currentTarget) setMobileNavOpen(false); }}>
        <aside className="mobileNavDrawer" id="mobile-navigation" aria-label="Mobile navigation">
          ...
          <nav><span className="mobileToolkitPlaceholder" aria-disabled="true">Toolkit</span><a href="https://racescanner.trackstrats.com" target="_blank" rel="noreferrer">Race Scanner<span aria-hidden="true">↗</span></a><a href="https://racecards.trackstrats.com" target="_blank" rel="noreferrer">Racecards<span aria-hidden="true">↗</span></a><a href="https://aheadofthemark.trackstrats.com" target="_blank" rel="noreferrer">Ahead Of The Mark<span aria-hidden="true">↗</span></a><a href="https://furthestfromhome.trackstrats.com" target="_blank" rel="noreferrer">Furthest From Home<span aria-hidden="true">↗</span></a><a href="https://trackstrats.com" target="_blank" rel="noreferrer">Shop<span aria-hidden="true">↗</span></a>{!session.loading && (session.authenticated ? <a className="mobileAccountAction" href="/auth/logout">Log out{session.customer?.firstName ? ` · ${session.customer.firstName}` : ""}<span aria-hidden="true">↗</span></a> : <a className="mobileAccountAction" href="/auth/login">Log in<span aria-hidden="true">↗</span></a>)}</nav>
        </aside>
      </div>
    </header>
